<table
    ...
    <tbody>
        ...
        <?php if (($swimlane['position'] == 1 Xor $this->task->projectUsesBacklogBoardModel->backlogIsset($project['id'])) || (!$this->task->projectUsesBacklogBoardModel->backlogIsset($project['id']))): ?>
            <td>
